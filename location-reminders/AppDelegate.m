...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ParseClientConfiguration *parseConfig = [ParseClientConfiguration configurationWithBlock:^(id<ParseMutableClientConfiguration>  _Nonnull configuration) {
        ...
        configuration.applicationId = @"sd231sfgd65fh";
        configuration.clientKey = @"gflu423sfjo874f0khf";
        
        configuration.server = @"https://location-services-server.herokuapp.com/parse";
    }];
